...
def main(page: ft.Page):
    ...
    page.title = "Calculadora con Flat"
    ...
    text = ft.TextField(
        read_only=True, border_color=ft.colors.BLACK, text_align="right",
        text_style=ft.TextStyle(size=30, color="white")
    )
    
    line_container = ft.Container(
        content=text,
        border=ft.Border(bottom=ft.BorderSide(width=2, color=ft.colors.BLUE))
    )
    
    page.add(line_container)
    
    page.add(
        ft.Row([
            ft.ElevatedButton(
                text="1", bgcolor=ft.colors.TRANSPARENT, color=ft.colors.WHITE,
                style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=10), padding=25,
        ...
        ft.Row([
            ft.ElevatedButton(
                ...
                style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=10), padding=25,
                                     shadow_color=ft.colors.RED, side=ft.BorderSide(width=2, color=ft.colors.RED)),
                data="C", on_click=get_data, elevation=5),
            ft.ElevatedButton(
                text="⌫", bgcolor=ft.colors.TRANSPARENT, color=ft.colors.WHITE,
                style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=10), padding=25,
                                     shadow_color=ft.colors.BLUE, side=ft.BorderSide(width=2, color=ft.colors.RED)),
